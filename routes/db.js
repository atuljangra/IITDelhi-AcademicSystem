...
query1 =[client.query('CREATE TABLE if not exists deptmaster(dpid VARCHAR(20) PRIMARY KEY not null,deptname VARCHAR(50) not null)'),
				...
				client.query('CREATE TABLE if not exists coursesoffered(crid VARCHAR(20) PRIMARY KEY not null, facid VARCHAR(50) not null, semid VARCHAR(20) , slotid VARCHAR(20) not null,  numseats VARCHAR(20) not null,  totalapplicants varchar(50) not null,  status varchar(50))'),
				];
