...
query1 =[client.query('CREATE TABLE if not exists deptmaster(dpid VARCHAR(20) PRIMARY KEY not null,deptname VARCHAR(50) not null)'),
				...
				client.query('CREATE TABLE if not exists coursesoffered(crid VARCHAR(20) PRIMARY KEY not null, facid VARCHAR(50) not null, semid VARCHAR(20) not null, slotid VARCHAR(20),  numseats int,  totalapplicants int,  statuscode varchar(10))'),
				client.query('CREATE TABLE if not exists coursesregistered(crid VARCHAR(20) PRIMARY KEY not null, stid VARCHAR(50) not null, semid VARCHAR(20) not null)'),
				];
